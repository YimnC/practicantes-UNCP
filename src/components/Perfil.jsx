...
const ProfilePage = () => {
  return (
    <div className="bg-cover bg-center h-screen flex items-center justify-center h-full w-full " >
      <div className="grid grid-cols-3 gap-4">
        <div class=" text-xl/8  text-center rounded-xl col-span-3 row-start-1">
          <p className='title-3'>- PERFIL DE USUARIO -</p><br />
        </div>
        <aside class="bg-gray-100 p-10 rounded-lg w-full max-w-lg font-mono row-start-2 col-start-1 shadow-gray-800 shadow-md">
        ...
        <aside class="bg-gray-100 text-white p-10 rounded-lg w-full max-w-lg font-mono row-start-3 col-start-1 shadow-gray-800 shadow-md">
          <div class="flex justify-between items-center">
            <div class="flex space-x-2 text-red-500">
              <div class="w-3 h-3 rounded-full bg-red-500"></div>
              <div class="w-3 h-3 rounded-full bg-yellow-500"></div>
        ...
        <div className="card flex items-center justify-center col-start-2 row-start-2 row-span-3 shadow-gray-800 shadow-md">
          <img className="rounded-full" alt="Foto de perfil" />
        </div>
